...
root_path = '/home/fiiser/Documents/ML/workspace/planet/1080ti_area/inceptionV3/f_beta_20_epoch/'

callbackpath =  root_path + 'inceptionv3_{val_loss:.4f}-{val_binary_accuracy:.4f}-{val_recall:.4f}.hdf5'
high_recall_callbackpath =  root_path + 'inceptionv3_recall_{val_loss:.4f}-{val_binary_accuracy:.4f}-{val_recall:.4f}.hdf5'

csv_filepath = '/home/fiiser/Documents/ML/workspace/planet/train_v2.csv'
logger_filepath = root_path + 'inceptionv3_log.csv'
image_size = 256
...
def learning_rate_scheduler(epoch_index):
    ...
    if epoch_index < 9:                         # 1-8
        lr = 3e-05
        # lr = 1e-03
    elif epoch_index < 15 and epoch_index > 8:  # 9-14
        lr = 1e-05
    elif epoch_index < 19 and epoch_index > 14:  # 15-18
        lr = 3e-06
    elif epoch_index < 21 and epoch_index > 18: # 19-20
        lr = 1e-06
...
def train_model(model, num_fold, train_idx, test_idx, files, categories, labelencoder):
    ...
    # if num_fold != 1:
    #     model_name = modelpath + 'InceptionV3_onlyF2_beta_8_fold_adam_{}.h5'.format(num_fold - 1)
    #     model.load_weights(model_name)

    # model_name = root_path + 'InceptionV3_fine_tune_{}.h5'.format(num_fold)
    ...
    callbacks = [
        ...
        # ReduceLROnPlateau(monitor='val_loss', factor=0.33, patience=3, verbose=0, mode='min', epsilon=0.0001, cooldown=2, min_lr=1e-08),
...
def main():
    ...
    model_path = '/home/fiiser/Documents/ML/workspace/planet/1080ti_area/inceptionV3/warm_up_3_epoch_1e-03/inceptionv3_0.1487-0.9434-0.7540.hdf5'
