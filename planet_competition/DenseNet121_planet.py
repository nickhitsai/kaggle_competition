...
nfolds = 5
batch_size = 32
samples_valid_per_epoch = 256 # 32400 / (epochs*batch_size)
...
def learning_rate_scheduler(epoch_index):
    ...
    if epoch_index < 7:                         # 1-6
        lr = 3e-05
        # lr = 1e-03
    elif epoch_index < 10 and epoch_index > 6:  # 7-9
        lr = 1e-05
    elif epoch_index < 12 and epoch_index > 9:  # 10-11
        lr = 3e-06
    elif epoch_index < 14 and epoch_index > 11: # 12-13
        lr = 1e-06
    elif epoch_index < 16 and epoch_index > 13: # 14-15
        lr = 3e-07
    else:                                       # 15
        lr = 1e-07
...
def model_generator():
    ...
    predictions = Dense(num_classes, activation='sigmoid')(base_model.layers[-2].output)
...
def main():
    ...
    model_path = '/home/fiiser/Documents/ML/workspace/planet/1080ti_area/dense121/warm_up_3_epoch_1e-03/DenseNet_0.1352-0.9493-0.8026.hdf5'
